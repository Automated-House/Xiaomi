...
metadata {
	definition(name: "Xiaomi Aqara Water Sensor", namespace: "prjct92eh2", author: "prjct92eh2") {
        ...
        fingerprint inClusters: "0000,0001,0003,000F,0020,0402,0500", outClusters: "0019", manufacturer: "LUMI", model: "lumi.sensor_wleak.aq1", deviceJoinName: "Xiaomi Water Sensor"
	}
